...
kaos_error_t start_server(channel_t *channels, uint8_t **ip_addr, uint32_t n_entries) {
    translation_table_init(channels, ip_addr, n_entries);
    init_network();
    ...
    create_task(channel_server_task, "udp_server", 4096, (void*)AF_INET, 5, NULL);
    create_task(channel_client_task, "udp_client", 4096, NULL, 5, &udp_client_handle);
    create_task(service_server_task, "tcp_server", 4096, (void*)AF_INET, 5, NULL);
    create_task(service_client_task, "tcp_client", 4096, NULL, 5, NULL);
